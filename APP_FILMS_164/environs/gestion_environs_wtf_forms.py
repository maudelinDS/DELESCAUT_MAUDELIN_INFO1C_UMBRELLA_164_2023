...
class FormWTFAjouterGenres(FlaskForm):
    """
        Dans le formulaire "environs_ajouter_wtf.html" on impose que le champ soit rempli.
...
class FormWTFUpdateGenre(FlaskForm):
    """
        Dans le formulaire "environ_update_wtf.html" on impose que le champ soit rempli.
        Définition d'un "bouton" submit avec un libellé personnalisé.
    """
...
class FormWTFDeleteGenre(FlaskForm):
    """
        Dans le formulaire "environ_delete_wtf.html"
